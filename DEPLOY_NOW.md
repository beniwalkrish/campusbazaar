...
2. Repository name: `campusbazaar`
3. Description: `Hyperlocal campus marketplace for Thapar students`
4. Choose **Public**
...
git remote add origin https://github.com/beniwalkrish/campusbazaar.git
git branch -M main
...
Visit: https://github.com/beniwalkrish/campusbazaar
...
5. Paste: `https://github.com/beniwalkrish/campusbazaar`
6. Click **Import**
7. Click **Deploy**
...
**https://campusbazaar.vercel.app** (or a custom name Vercel assigns)
